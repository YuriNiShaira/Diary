        ...
        >
          ...
          >
            ...
            <div className="relative overflow-visible rounded-xl bg-[#2C292A] p-2 pb-3 pr-3 shadow-[0_30px_60px_rgba(0,0,0,0.5)] dark:bg-[#1A1819]">
              ...
              <div className="light-book-page relative flex h-[650px] md:h-[650px] w-full overflow-hidden rounded bg-[#FDFBF7] dark:bg-[#FDFBF7]" style={{ perspective: "2500px" }}>
                ...
                <AnimatePresence mode="popLayout" custom={direction}>
                  <motion.div
                    ...
                    {/* LEFT PAGE */}
                    <div className="relative flex shrink-0 w-full flex-col items-center justify-center p-8 md:h-full md:w-1/2 md:p-12 bg-[#FDFBF7]">
                      {currentMemory.image ? (
                        <div className="polaroid-bg relative group -rotate-2 bg-white p-4 pb-12 shadow-[0_10px_25px_rgba(0,0,0,0.15)] transition-transform duration-500 hover:rotate-0">
                          ...
                          <img src={currentMemory.image} alt={currentMemory.title}
                            className="h-60 w-55 object-cover shadow-inner md:h-90 md:w-80" />
                        ...
                        <div className="polaroid-bg flex h-60 w-55 md:h-90 md:w-80 -rotate-2 flex-col items-center justify-center border-2 border-dashed border-gray-300 bg-white">
                    ...
                    {/* RIGHT PAGE */}
                    <div className="relative flex flex-1 w-full flex-col bg-[#FDFBF7] p-8 md:h-full md:w-1/2 md:p-12 md:pl-16">
                      ...
                      <div className="relative z-10 mt-auto flex shrink-0 justify-center gap-4 pt-4 pb-2">
                        <button
                          onClick={() => {
                            // Close the BookModal first to avoid race conditions
                            // with navigation and duplicated modal mounts.
                            onClose();
