...
const JoinPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 sm:p-8 relative overflow-hidden bg-[#f5f0ff]">
      {/* Background Glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] h-[900px] bg-purple-200/40 rounded-full blur-[110px] pointer-events-none z-0" />
      ...
      >
        {/* Vibrant Hardcover (Color-matched directly to the button gradient) */}
        <div className="absolute inset-0 bg-gradient-cover-purple rounded-2xl shadow-[0_20px_50px_rgba(139,92,246,0.4)] md:-inset-2 md:rounded-[1.5rem]" />
        
        {/* Cover Stitching/Inlay Detail */}
        <div className="absolute inset-1 border border-dashed border-white/20 rounded-xl md:-inset-1 md:rounded-[1.25rem] pointer-events-none hidden md:block" />

        {/* The Pages Wrapper */}
        <div className="relative flex bg-[#f5f5f5] rounded-xl md:rounded-lg shadow-inner overflow-hidden border border-purple-200/30">
          ...
          <div className="hidden md:block absolute top-0 bottom-0 left-1/2 -translate-x-1/2 w-10 bg-gradient-to-r from-black/5 via-black/15 to-black/5 z-20 pointer-events-none" />
          <div className="hidden md:block absolute top-0 bottom-0 left-1/2 -translate-x-1/2 w-[1px] bg-black/15 z-20 pointer-events-none" />

          {/* --- RIGHT PAGE (Join Form) --- */}
                ...
                <div className="bg-purple-50/80 p-4 rounded-xl border border-purple-200 shadow-inner">
                  ...
                  <div className="relative">
                    ...
                    <input type="text" name="invite_code" value={formData.invite_code} onChange={handleChange}
                      className="w-full pl-11 pr-4 py-3 bg-white text-purple-800 border border-purple-100 rounded-lg focus:ring-4 focus:ring-purple-400/20 focus:border-purple-300 font-bold shadow-sm transition-all text-center tracking-[0.3em] uppercase" placeholder="ABC123" maxLength={6} required />
                  </div>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <input type="text" name="username" value={formData.username} onChange={handleChange}
                      className="w-full pl-11 pr-4 py-3 bg-white/80 text-gray-800 border border-purple-100 rounded-xl focus:ring-4 focus:ring-purple-400/20 focus:border-purple-300 font-medium shadow-inner transition-all text-sm" placeholder="Username" required />
                  </div>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <input type="text" name="display_name" value={formData.display_name} onChange={handleChange}
                      className="w-full pl-11 pr-4 py-3 bg-white/80 text-gray-800 border border-purple-100 rounded-xl focus:ring-4 focus:ring-purple-400/20 focus:border-purple-300 font-medium shadow-inner transition-all text-sm" placeholder="First Name" required />
                  </div>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <input type="password" name="password" value={formData.password} onChange={handleChange}
                      className="w-full pl-11 pr-4 py-3 bg-white/80 text-gray-800 border border-purple-100 rounded-xl focus:ring-4 focus:ring-purple-400/20 focus:border-purple-300 font-medium shadow-inner transition-all text-sm" placeholder="At least 6 characters" minLength={6} required />
                  </div>
                </div>
